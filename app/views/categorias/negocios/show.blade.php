...
<div class="row">
	<div class="col-md-12">
        ...
        {{ HTML::link('categoriasNegocios', 'Regresar a categorias', array('class' => 'btn btn-default pull-left')); }}
		</div>
	</div>
</div>
...
<div class="clearfix btn-block">
	<div class="pull-right">
		{{ HTML::link(route('categoriasNegocios.edit', array($categoria->id)), 'Editar', array('class' => 'btn btn-default')); }}
		<button type="button" class="btn btn-default" data-toggle="modal" data-target="#gridSystemModal">Eliminar</button>
	
	</div>
</div>

{{ Form::open(array('url' => 'categoriasNegocios/' . $categoria->id, 'class' => 'pull-right')) }}
