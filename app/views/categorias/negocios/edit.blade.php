...
<div class="row">
	<div class="col-md-12">
		<div class="clearfix btn-block">
        	{{ HTML::link(route('categoriasNegocios.show', array($categoria->id)), 'Regresar a detalle', array('class' => 'btn btn-default pull-left')); }}
		</div>
	</div>
</div>

{{ Form::model($categoria, array('route' => array('categoriasNegocios.update', $categoria->id), 'class' => 'form-horizontal', 'files' => true, 'method' => 'PUT')) }}
