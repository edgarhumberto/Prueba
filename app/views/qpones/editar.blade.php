...
<div class="row">
	<div class="col-md-12">
        ...
        {{ HTML::link('qpones/'.$qpon->id, 'Regresar al qpon', array('class' => 'btn btn-default pull-left')); }}
		</div>
	</div>
</div>

{{ Form::model($qpon, array('url' => 'qpones/actualizar/'.$qpon->id, 'class' => 'form-horizontal', 'files' => true)) }}
...
<div class="panel panel-success panel-custom">
    <div class="panel-heading">
        <h1 class="panel-title">Editar Qpon</h1>
    </div>
    <div class="panel-body">
    	*campos obligatorios
	        <div class="form-group">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-4">
	                {{Form::text('vigenciaHasta', null, array("class" => "form-control", "id" => "vigencia"))}}
	        ...
	        <div class="form-group">
				...
				<div class="col-sm-4">
					{{ Form::checkbox('habilitado', 1, null, ['class' => 'form-control']) }}
				</div>
	        ...
	        <div class="form-group">
	            <div class="col-sm-offset-3 col-sm-9">
	                {{Form::submit('Actualizar', array("class" => "btn btn-success pull-right"))}}
	            </div>
	        </div>
    </div>
  ...
  if(navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function(position) {
	  ...
	  //mapContext.map.setCenter(pos);
		$('#us2').locationpicker({
		location: {latitude: {{ $qpon->latitud }}, longitude: {{ $qpon->longitud }} },	
		radius: 300,
		inputBinding: {
