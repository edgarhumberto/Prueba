...
<div class="row">
	<div class="col-md-12">
        ...
        {{ HTML::link(route('negocios.show', array($negocio->id)), 'Regresar al negocio', array('class' => 'btn btn-default pull-left')); }}
		</div>
		
	</div>
</div>
		
		{{ Form::model($negocio, array('route' => array('negocios.update', $negocio->id), 'class' => 'form-horizontal', 'files' => true, 'method' => 'PUT')) }}
			...
			<div class="panel-body">
				*campos obligatorios
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						{{Form::text('plaza', null, array('class' => 'form-control', 'id' => 'plaza'))}}
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{Form::text('numeroExterior', null, array('class' => 'form-control', 'id' => 'numeroExterior'))}}
					</div>
					{{Form::label('numeroInterior', 'Número Interior:', array('class' => 'col-sm-2 control-label'))}}
					<div class="col-sm-4">
						{{Form::text('numeroInterior', null, array('class' => 'form-control', 'id' => 'numeroInterior'))}}
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{Form::text('delegacion', null, array('class' => 'form-control', 'id' => 'delegacion'))}}
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{Form::text('estado', null, array('class' => 'form-control', 'id' => 'estado'))}}

					</div>
					{{Form::label('pais', '*País:', array('class' => 'col-sm-2 control-label'))}}
					<div class="col-sm-4">
						{{Form::text('pais', null, array('class' => 'form-control', 'id' => 'pais'))}}
					</div>
				</div>
			</div>
		</div>
       ...
       <div class="panel panel-success panel-custom">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{Form::text('etiquetas', null, array('class' => 'form-control', 'id' => 'etiquetas'))}}
					</div>
				</div>
				<div class="form-group">
       ...
       <div class="form-group hidden">
			...
			<div class="col-sm-4">
				{{Form::text('latitud', null, array('class' => 'form-control', 'id' => 'us3-lat'))}}
			</div>
			<label class="col-sm-2 control-label">Longitud:</label>
			<div class="col-sm-4">
				{{Form::text('longitud', null, array('class' => 'form-control', 'id' => 'us3-lon'))}}
			</div>
		</div>
  ...
  if(navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function(position) {
	  ...
	  //mapContext.map.setCenter(pos);
		$('#us2').locationpicker({
		location: {latitude: {{ $negocio->latitud }}, longitude: {{ $negocio->longitud }} },	
		radius: 300,
		inputBinding: {
